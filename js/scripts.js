let pokemonRepository = (function() {
  // function is anonymous since no parameter is given to it
  ...
  function getAll() {
    // function "getAll" that returns all the data from the "pokemonList"
    return pokemonList;
  }
  ...
  function addListItem(pokemon) {
    ...
    button.addEventListener('click', function(event) {
      // "Event" added to the "click" of the button
  ...
  function loadList() {
    ...
    return fetch(apiUrl)
      .then(function(response) {
        // returns the data fetched from apiURL link on top of the script. If the promise takes place...
        return response.json();
      })
      .then(function(json) {
        json.results.forEach(function(item) {
          // ...then for each "item" from the "pokemon" variable the name and detailsUrl are beeing displayed
          let pokemon = {
            name: item.name,
            detailsUrl: item.url
          };
      ...
      .catch(function(e) {
        // if the promise fails, function "e" takes place
        console.error(e);
      });
  }
  ...
  function loadDetails(item) {
    ...
    return fetch(url)
      ...
      .then(function(details) {
        // if the promise takes place, following details will be fetched
      ...
      .catch(function(e) {
        // otherwise the error will be displayed in the console
        console.error(e);
      });
  }
